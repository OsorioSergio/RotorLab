...
_VIEW_CUBE_BODY_SCALE = 1.15
_VIEW_CUBE_SIZE = 120.0 * _VIEW_CUBE_BODY_SCALE
_VIEW_CUBE_PADDING = 12.0
_VIEW_CUBE_WIDGET_WIDTH = 182.0
_VIEW_CUBE_WIDGET_HEIGHT = 174.0
_VIEW_CUBE_WIDGET_INSET_X = 86.0
_VIEW_CUBE_WIDGET_INSET_Y = 93.0
_VIEW_CUBE_CHAMFER_RATIO = 0.23
_VIEW_CUBE_CORNER_RADIUS = 9.0 * _VIEW_CUBE_BODY_SCALE
_VIEW_CUBE_EDGE_RADIUS = 7.0 * _VIEW_CUBE_BODY_SCALE
_VIEW_CUBE_FOV_DEGREES = 28.0
_VIEW_CUBE_CAMERA_DISTANCE = 6.2
_VIEW_CUBE_FIT_FRACTION = 0.84
_VIEW_CUBE_CONTROL_SIZE = 18.0
_VIEW_CUBE_CONTROL_GAP = 4.0
